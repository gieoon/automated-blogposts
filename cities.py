...
def get_keywords():
    ...
    with open('cities.csv') as f:
        ...
        for row in reader:
            ...
            if row['country'].lower() == 'new zealand' or row['country'].lower() == 'australia':
                ...
                # Need to work from here, and all of NZ.
                if keyword == 'Booval':
                    is_allowed = True
                ...
                messages=[
                    {"role": "user", 
                    "content": f"An article about Webbi Digital Studio's website design services with a world class global team with easy to use and beautiful websites in '{keyword}'."}
                ]
